...
st.set_page_config(layout="wide", page_title="Code Vault")
padding = 3
st.markdown(f""" <style>    
...
# ------------------------------- #
# Sidebar + Main panel
col1.image("images/Cryptonomicsgoldbannersmall.png")
...
col2.image("images/Cryptonomicsgoldbanner.png")
...
if option == 'Blockchain Explorer':
    ...
    if title == "Binance Smart Chain: BNB":
        ...
        col2.image("images/330px-Binance_logo.svg.png")
